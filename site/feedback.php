...
<!-- / header -->
	...
	<div class="body2">
		...
		<div class="main"> <label id="w1">	Welcome , <?php 
					
	
						echo $_SESSION["username"]; ?>
                     </label><a href="log_outcode.php">Log out</a>
<!-- content -->
			<section id="content">
				<div class="box1">
					<div class="wrapper">
						<article class="col1">
							<div class="pad_left1">
								<h2>Feedback Form</h2>
								<form id="ff" name="ff" method="post" action="feedbackcode.php" onSubmit="return validateFeedback()">
									<div>
										<div  class="wrapper">
											<strong>Name:</strong>
											<div class="bg"><input type="text" class="input" id="t1" name="t1"></div>
										</div>
										<div  class="wrapper">
											<strong>Email:</strong>
											<div class="bg"><input type="text" class="input" id="t2" name="t2"></div>
										</div>
										<div  class="textarea_box">
											<strong>Message:</strong>
											<div class="bg"><textarea name="textarea" id="textarea" cols="1" rows="1"></textarea>	</div>
										</div>
