...
<!-- content -->
			<section id="content">
				<div class="box1">
					<div class="wrapper">
					  <article class="col1">
					    <div class="pad_left1">				<table width="400" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<tr>
<form id="form1" name="form1" method="post"  onsubmit="return validateCTopic()" action="add_topic.php">
<td>
<table width="107%" height="250" border="0" cellpadding="3" cellspacing="1" bgcolor="#0099FF">
<tr>
<td colspan="3" bgcolor="#0099FF"><p><strong>Ask Question</strong></p></td>
</tr>
<tr>
