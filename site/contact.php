				...
				<div class="box1">
					<div class="wrapper">
						<article class="col1">
							<div class="pad_left1">
								<h2>Contact Us</h2>
								<form id="contactform" name="cf" onSubmit="return validateContact()" method="post" action="contactcode.php">
									<div>
										<div  class="wrapper">
											<strong>Name:</strong>
											<div class="bg"><input type="text" class="input" id="c1" name="c1"></div>
										</div>
										<div  class="wrapper">
											<strong>Email:</strong>
											<div class="bg"><input type="text" class="input" id="c2" name="c2"></div>
										</div>
										<div  class="textarea_box">
											<strong>Message:</strong>
											<div class="bg"><textarea name="c3" id="c3" cols="1" rows="1"></textarea>	</div>
										</div>
